...
- **Node.js/Express MCP Server**
  - API endpoint for handling the chatbot requests
...
### To replicate the full project

- To test the admin role the credentials are "AirQuality" and "SecretPassword"
- In the .env file of the services directory add a "GOOGLE_API_KEY" entry and generate your personal key with [Google API Keys](https://aistudio.google.com/api-keys)
