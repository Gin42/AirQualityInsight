      ...
      measurements: {
        ...
        no2: {
          ...
          info: {
            ...
            measurementUnit: "µg/m³",
            description:
              "A reddish-brown gas primarily produced by vehicle emissions and industrial combustion. It contributes to smog formation, acid rain, and can cause respiratory irritation. High concentrations are often found in urban areas with heavy traffic.",
          },
        },
        o3: {
          label: "O3",
          ...
          info: {
            ...
            measurementUnit: "µg/m³",
            description:
              "At ground level, ozone is a harmful pollutant formed when nitrogen oxides and volatile organic compounds react in sunlight. It's a key component of smog and can cause breathing problems, especially during hot, sunny days. Note that this is different from the protective ozone layer in the upper atmosphere.",
          },
        },
        so2: {
          label: "SO2",
          ...
          info: {
            ...
            measurementUnit: "µg/m³",
            description:
              "A colorless gas with a sharp, irritating smell, mainly produced by burning fossil fuels containing sulfur (coal, oil) and industrial processes. It can cause respiratory problems and contributes to acid rain formation. Power plants and refineries are major sources.",
          },
        },
      },
      infoMeasurement: {
        columns: [
          ...
          {
            key: "thresholdVeryPoor",
            label: "Very poor",
            center: true,
            html: true,
          },
          {
            key: "thresholdExtremelyPoor",
            label: "Extremely poor",
            center: true,
            html: true,
          },
    ...
    <div class="dashboard">
      <div class="dashboard-component info-component-container">
        <div class="description">
          <h2>Description</h2>
          <p>
            Simulation project of a sensor system to monitor air quality, with
            data sent to a server for real-time analysis and visualization.
          </p>
          <p>
            The system simulates a network of sensors, such as Raspberry Pi,
            capable of measuring air quality. These measurements will be sent to
            a server, which will analyze them and present the data in real-time
        ...
        <div class="measurement-ranges">
          ...
          />
          <p>
            The table above explains what types of measurements are collected
            and how they are interpreted. It shows the measurement name, the
            unit of measurement, the sampling interval, and 3 indicators that
            represent the quality of the obtained measurement: the closer the
            measurement value is to the quality thresholds, the better the
            value. If you hover the cursor over the information label, a brief
